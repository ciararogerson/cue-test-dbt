{% macro get_metrics_models() %}
  ...
  {% else %}
    ...
    {% set metric_models = ['metrics_user_engagement', 'metrics_paid_conversion', 'metrics_membership_engagement', 'metrics_sales', 'metrics_user_base', 'metrics_logs', 'metrics_members_activity', 'metrics_activity_retention', 'metrics_onboarding_conversion', 'metrics_support_mode_conversion', 'metrics_model_checks'] %}
